...
The method names have been slightly changed. Here's the mapping of the method names used by this this module and the corresponding method names in the TMDb API:
    ...
    Movie Credits                     movie/[TMDb ID]/credits            movie->credits()
    Movie Images                      movie/[TMDb ID]/images             movie->images()
    Movie Keywords                    movie/[TMDb ID]/keywords           movie->keywords()
    Movie Release Info                movie/[TMDb ID]/release_dates      movie->release_dates()
    Movie Trailers                    movie/[TMDb ID]/videos             movie->videos()
    Movie Translations                movie/[TMDb ID]/translations       movie->translations()
    TV Info                           tv/[TMDb ID]                       tv->info()
    TV Alternative Titles             tv/[TMDb ID]/alternative_titles    tv->alternative_titles()
    TV Credits                        tv/[TMDb ID]/credits               tv->credits()
    TV Images                         tv/[TMDb ID]/images                tv->images()
    TV Keywords                       tv/[TMDb ID]/keywords              tv->keywords()
    TV Translations                   tv/[TMDb ID]/translations          tv->translations()
    TV Content Ratings                tv/[TMDb ID]/content_ratings       tv->content_ratings()
    ...
    Latest Movie                      movie/latest                       movie->latest()
    Latest TV                         tv/latest                          tv->latest()
...
=back
        ...
        $result = $api->movie->credits( ID => 903 );
...
=head2 movie->release_dates( %params )
...
=back
        ...
        $result = $api->movie->release_dates( ID => 903 );
...
v0.05 Geoff Westcott C<< <honir999@gmail.com> >>
